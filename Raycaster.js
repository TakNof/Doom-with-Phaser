...
//      * @param {
//      */
//     constructor(angle, spritePositionX, spritePositionY, rayAmount){
//         // this.rayAngle = angle + 5*Math.PI/4;
//         this.rayAngle = angle + 3*Math.PI/2;
...
//             let fixAngle = this.rayAngle - currentAngle;
...
class Raycaster{
    ...
    set setSpritePosition(playerPosition){
    ...
    drawRays2D(){
        ...
        for(let i = 0; i < this.rayAmount; i++){
            ...
            // console.log(playerAngle*180/Math.PI, (this.rayAngle - 5*Math.PI/4)*180/Math.PI, this.rayAngle*180/Math.PI,);

            let fixAngle = this.rayAmount - 5*Math.PI/4 - currentAngle;
