class Projectile extends Living{
    ...
    */
    ...
    setProjectile3D(scene3D, positionX, positionY, ProjectileImgStr, visible = false){
        this.getSprite.sprite3D = new Sprite(scene3D, {x: positionX, y: positionY}, ProjectileImgStr, this.getSize, 3)
        this.getSprite.sprite3D.setVisible = visible;
    }
     ...
     */
    get getProjectile3D(){
        return this.getSprite.sprite3D;
    }
