class Scene1 extends Phaser.Scene {
    ...
    create(){ 
        sharedScenes.scene1 = this;

        let scene2 = sharedScenes.scene2;
        ...
        this.player = new Player(this, scene2, {x: this.canvasSize.width/2, y: this.canvasSize.height/2}, "player", this.wallBlockSize*2, 0, this.defaultVelocity, this.angleOperator, 100);
        ...
        this.cacodemons = new Cacodemon(this, scene2, this.canvasSize,this.amountEnemies, this.walls.getWallMatrix, this.walls.getWallNumberRatio, this.wallBlockSize, this.defaultVelocity/2, this.chaseDistance, this.allowChase);
